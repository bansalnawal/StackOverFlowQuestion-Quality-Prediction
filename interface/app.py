...
# LOad all the models
f = open('../models/bagging', 'rb')
bagging = pickle.load(f)

f = open('../models/decision_tree', 'rb')
decisionTree = pickle.load(f)

f = open('../models/logistic_reg', 'rb')
logisticReg = pickle.load(f)

f = open('../models/mlp', 'rb')
mlp = pickle.load(f)

f = open('../models/naive_bayes', 'rb')
naiveBayes = pickle.load(f)

f = open('../models/random_forest', 'rb')
randomForest = pickle.load(f)

f = open('../models/stack', 'rb')
stack = pickle.load(f)

f = open('../models/svc', 'rb')
svc = pickle.load(f)

f = open('../models/voting', 'rb')
voting = pickle.load(f)

f = open('../models/xgboost', 'rb')
